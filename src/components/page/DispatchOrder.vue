<template>
    <div class="orderBox">
        <div class="MyOrder" v-if="box">
                    ...
                    <el-tabs v-model="activeName1" @tab-click="handleClick">
                        <el-tab-pane label="基本信息" name="first">
                            <div class="news" ref="copy">
                                ...
                                <div
                                    class="news1"
                                >{{news.zxte?news.zxte:""}}{{news.odc?"、"+news.odc:""}}{{news.dc?"、"+news.dc:""}}</div>
                                <div class="price">
                                    期望运费：
                                ...
                                <a
                                    href="javascript:;"
                                    class="operation-text bar_btn copy_btn copy"
                                    @click="copy"
                                    :data-clipboard-text="message"
                                >复制</a>
                            </div>
                        ...
                        <el-tab-pane label="详细地址" name="second">
                            ...
                            <div class="endAddress">
                                <div class="yuan"></div>
                                <div class="text" v-if="news.zad">{{news.xad}}</div>
                            </div>
                            <div class="line1"></div>
                            <div class="endAddress">
                                <div class="yuan"></div>
                                <div class="text" v-if="news.zadp">{{news.xadp}}</div>
                            </div>
                            <div class="line"></div>
                            <div class="end">
            ...
            <div class="box3" v-if="box4">暂无数据</div>
        </div>
        <sendCart v-if="box2" @goBack="goBack"></sendCart>
        <contract v-if="box3" @goBack="goBack"></contract>
        <Chargeback ref="Chargeback" @getData="getData"></Chargeback>
        <offer ref="offer" @refresh="refresh"></offer>
    </div>
</template>
<script>
...
import Chargeback from '../popup/Chargeback.vue';
import offer from '../popup/offer.vue';
import sendCart from './sendCart.vue';
...
export default {
    ...
    methods: {
        ...
        async getData() {
            let action = this.$store.state.Login.url + '/30066';
            ...
            let res = await request('/30066', hd, bd);
        ...
        async details(item, index) {
            ...
            let action = this.$store.state.Login.url + '/30067';
            // this.loginData = this.$store.state.Login.CustomerData;
            ...
            let res = await request('/30067', hd, bd);
            let rid = res.data.hd.rid;
            if (rid >= 0) {
                let data = {};
                if (this.loginData.em == 0) {
        ...
        //普通派车
        carDispatch() {
            // console.log(this.detailsData.txr)
            this.popup2 = this.orderData;
