<template>
    <div class="orderBox">
            ...
            <div class="right" v-if="box1">
                    ...
                    <el-tabs v-model="activeName1" @tab-click="handleClick">
                        ...
                        <el-tab-pane label="订单信息" name="second">
                            <div class="news" ref="copy">
                                ...
                                <div class="orderNews">
                                    <div class="yuan">客</div>
                                    <!-- <div class="name">{{orderNews.dne}}</div> -->
                                    <div class="name">{{orderNews.bne}}</div>
                                    <div class="phone">{{orderNews.bph}}</div>
                                </div>
                ...
                <div class="tab-operation">
                    <a
                        ...
                        @click="operation"
                    >修改地址</a>
                    <a href="javascript:;" class="operation-text" v-if="button2" @click="loading">装货</a>
                    <a
                        href="javascript:;"
                        class="operation-text"
                        v-if="button3"
                ...
                <div class="dispatchNew">
                    ...
                    <a href="javascript:;" class="revoke" @click="replace" ref="replace">{{mapName}}</a>
                </div>
                <div class="map">
                    <iframe
                        :src="src"
        ...
        <dispatchPerfect ref="dispatchPerfect" @refresh="refresh"></dispatchPerfect>
        ...
        <Signing ref="Signing" @open3="open3"></Signing>

        <rectify ref="rectify"></rectify>
...
import dispatchPerfect from '../popup/dispatchPerfect.vue';
...
export default {
    ...
    methods: {
        ...
        //完善收发信息
        operation() {
            this.$refs.dispatchPerfect.receipt();
        },
        //装货
        loading() {
            // this.popup2 = {
        ...
        replace() {
            ...
            // this.map2 = false;
            //  console.log(111)
            let text = this.$refs.replace.innerText;
            console.log(text);
            if (text == '导航') {
                this.map1 = true;
                this.map2 = false;
