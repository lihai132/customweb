<template>
    <div>
        <div class="top">
            ...
            ></el-input>
            <el-button type="success" style="margin:0 0 0px 20px;" @click="getNewData">查 询</el-button>
        </div>
        <div class="container">
            <el-table
                :data="tableData"
            ...
            >
                ...
                <el-table-column prop="dis" label="距离（公里）" width="130"></el-table-column>
                <el-table-column label="服务费（元）" width="120" align="right">
                    <template slot-scope="scope">
                        <span style="color:red;">{{scope.row.dch}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="yf" label="总运费（元）" width="130" align="right">
                    <template slot-scope="scope">
                        <span style="color:red;">{{scope.row.yf}}</span>
                    </template>
                </el-table-column>
                <el-table-column label="司机运费（元）" width="130" align="right">
                    <template slot-scope="scope">
                        <span style="color:red;">{{scope.row.dyf}}</span>
                    </template>
                </el-table-column>
                <el-table-column label="待付司机运费（元）" width="180" align="right">
                    <template slot-scope="scope">
