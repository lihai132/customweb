                            ...
                            <div class="nav">
                                ...
                                >
                                    <el-form-item label="起运地" required>
                                        <el-input
                                            v-model="dynamicValidateForm1.start"
                                            :disabled="true"
                                            style="width:400px;"
                                            :maxlength="64"
                                        ></el-input>
                                    ...
                                    <el-form-item v-if="startRoute" label="途径地">
                                        <el-input
                                            v-model="dynamicValidateForm1.route"
                                            style="width:400px;"
                                            :maxlength="64"
                                        ></el-input>
                                    </el-form-item>
                            ...
                            <div class="nav">
                                ...
                                >
                                    <el-form-item label="目的地">
                                        <el-input
                                            v-model="dynamicValidateForm2.end"
                                            style="width:400px;"
                                            :maxlength="64"
                                        ></el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item v-if="endRoute" label="途径地">
                                        <el-input
                                            v-model="dynamicValidateForm2.route"
                                            style="width:400px;"
                                            :maxlength="64"
                                        ></el-input>
                                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        receipt(index, row) {
            ...
            this.dynamicValidateForm1.start = this.newsData.zct;
            this.dynamicValidateForm2.end = this.newsData.xct;

            this.start.name = this.orderData.fhr;
            this.start.phone = this.orderData.fhrp;
            ...
            this.dynamicValidateForm1.domains[0].value = this.orderData.zad;
            this.dynamicValidateForm1.route = this.orderData.zadp;
            this.dynamicValidateForm2.domains[0].value = this.orderData.xad;
            this.dynamicValidateForm2.route = this.orderData.xadp;
            if ( this.dynamicValidateForm1.route) {
                this.startRoute = true;
            } else {
                this.startRoute = false;
            }
            if ( this.dynamicValidateForm2.route) {
                this.endRoute = true;
            } else {
                this.endRoute = false;
            }
        ...
        //确定事件
        async determine() {
            let action = this.$store.state.Login.url + '/20043';
            let bd = {
                tid: this.loginData.tid,
                oid: this.orderData.oid,
                zid: this.orderData.zid,
                zad: this.dynamicValidateForm1.domains[0].value,
                zadp: this.dynamicValidateForm1.route,
                xid: this.orderData.xid,
                xad: this.dynamicValidateForm2.domains[0].value,
                xadp: this.dynamicValidateForm2.route,
            ...
            let res = await request('/20043', hd, bd);
