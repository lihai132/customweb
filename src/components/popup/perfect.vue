...
export default {
    ...
    methods: {
        ...
        receipt(index, row) {
            ...
            this.form1.domains[0].value = this.newsData.zad;
            this.form2.domains[0].value = this.newsData.xad;
            this.form1.route = this.newsData.zadp;
            this.form2.route = this.newsData.xadp;
