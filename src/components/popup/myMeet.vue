                            ...
                            <div class="box">
                                ...
                                <div class="box-center">
                                    <div class="CargoInformation">
                                        ...
                                        <div
                                            class="value"
                                        >{{news.dw?news.dw+"吨":""}}{{news.dv?news.dv+"方，":""}}{{news.on?news.on:""}}</div>
                                    </div>
                                    <div class="CargoInformation">
                            ...
                            <div class="box">
                                ...
                                <div class="box-center1">
                                    ...
                                    <div class="CargoInformation">
                                        ...
                                        <div
                                            class="value"
                                        >{{news.odc?news.odc:""}}{{news.dc?"、"+news.dc:""}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        receipt(index, row) {
            ...
            this.news.dc = this.popupData.data.dc;
        ...
        async determine() {
            ...
            let res = await request('/20008', hd, bd);
