<template>
    <div>
        <div class="top">
            ...
            ></el-date-picker>
            <el-select v-model="value" placeholder="订单状态" style="margin:0 0 0px 20px;">
                <el-option
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="ctm" label="创建时间" min-width="160"></el-table-column>
            </el-table>
        </div>
        <div class="page">
            <el-pagination
...
export default {
    ...
    methods: {
        ...
        async getData() {
            ...
            let action = `${this.$store.state.Login.url}/31008`;
            // this.loginData = this.$store.state.Login.DispatchData;
            ...
            let res = await request('/31008', hd, bd);
            // console.log(res);
